...
plt_delta = figure(x_axis_type='datetime', title='BTCUSDT 4 Hours Delta', width=1000, height=200, x_range=plt_candlestick.x_range)
plt_delta.vbar(x=df_vol_profile['open_time'], width=3.6e+6*4*0.8, top=df_vol_profile['delta'], bottom=0, fill_color='black', line_color=None)
show(column(plt_candlestick, plt_volume, plt_delta))